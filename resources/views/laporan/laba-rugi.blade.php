                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    {{-- <button type="button" id="btn-modal" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#custom-modal"><i class="mdi mdi-printer-check"></i> Parameter Print Laba Rugi</button> --}}
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form-print" action="{{ url("print-laba-params") }}" method="POST">
                        {{ csrf_field() }}
                        <div class="mb-3">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.18.1/moment.min.js"></script>
    <script>
        ...
        $("#form-print").submit(function(event) {
            ...
            // $.ajax({
            //     url: '{{ url("print-penjualan-params") }}',
            //     type: 'post',
            //     data: formData,
