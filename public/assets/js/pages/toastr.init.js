...
function (i) {
    ...
    }), i(".save-toast").on("click", function (t) {
        i.NotificationApp.send("Sukses !", "Berhasil menambahkan data", "top-right", "#5ba035", "success")
    }), i(".update-toast").on("click", function (t) {
        i.NotificationApp.send("Sukses !", "Berhasil merubah data", "top-right", "#5ba035", "success")
    }), i(".transaksi-toast").on("click", function (t) {
        i.NotificationApp.send("Sukses !", "Berhasil melakukan transaksi", "top-right", "#5ba035", "success")
    }), i(".acc-toast").on("click", function (t) {
        i.NotificationApp.send("Sukses !", "Dokumen telah disetujui", "top-right", "#5ba035", "success")
    }), i(".save-fail-toast").on("click", function (t) {
        i.NotificationApp.send("Gagal !", "Gagal menambahkan data, silahkan coba kembali.", "top-right", "#bf441d", "danger")
    }), i(".update-fail-toast").on("click", function (t) {
        i.NotificationApp.send("Gagal !", "Gagal menambahkan data, silahkan coba kembali", "top-right", "#bf441d", "danger")
    }), i(".transaksi-fail-toast").on("click", function (t) {
        i.NotificationApp.send("Gagal !", "Gagal melakukan transaksi, silahkan coba kembali", "top-right", "#bf441d", "danger")
    }), i(".acc-fail-toast").on("click", function (t) {
        i.NotificationApp.send("Gagal !", "Gagal menyetujui dokumen, silahkan coba kembali.", "top-right", "#bf441d", "danger")
    })
}(window.jQuery);
